...
const sketch = ({ context }) => {
    ...
    //when we use harsh, bright lighting, parts that are not shone upon will be 100% black
    //using ambient light helps us color these dark parts
  ...
  return {
    ...
    render ({ playhead }) {
      //t = Math.sin(playhead * Math.PI * 2);
      t = playhead * Math.PI * 2
      scene.rotation.y = t;
